    ...
    <div className="min-h-screen bg-[#F9F9F7] py-8 px-4" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-black text-[#333654] mb-1">הסכם התקשרות</h1>
          <p className="text-sm text-[#9091A8]">לניהול קייטנה עצמאי במסגרת אגף מבצע חינוך</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#E5E5E8] p-6 mb-6 text-sm text-[#333654] leading-relaxed space-y-3 shadow-sm">
          ...
          <p><span className="font-bold">אגף מבצע חינוך — תנועת חב"ד</span> (להלן: "הרשת")</p>
          <p>לבין</p>
          <p><span className="font-bold">השליח / מנהל הקייטנה</span> כמפורט להלן (להלן: "השליח")</p>
          ...
          <ol className="list-decimal list-inside space-y-2 text-[#4B4D6A]">
            <li>השליח ינהל קייטנה קיץ במסגרת הנחיות הרשת ובהתאם לתכניות האגף.</li>
            <li>הרשת תסייע לשליח בתכנון, תמיכה מקצועית ומשאבי תוכן.</li>
            <li>השליח מתחייב לדווח על פעילות הקייטנה ולשמור על רמת הפעילות הנדרשת.</li>
            <li>תשלומים ועמלות ייקבעו בהתאם למסמך הנספח שנמסר לשליח.</li>
            <li>הסכם זה בתוקף לשנת הפעילות הנקובה ויחודש בכל שנה בהסכמה הדדית.</li>
          </ol>
        </div>
